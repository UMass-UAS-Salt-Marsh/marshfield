## Pinned pipeline argument, verified 2026 against ~800 plots that Emlid had
## already computed with its own on-device GEOID18. Pinned so a PROJ upgrade
## can't silently substitute a different geoid (GEOID12B differs from GEOID18 by
## only a few cm in MA - it would look fine and be wrong). Change only after
